...
import IMAd
class SplashSpinLiteViewController: UIViewController
{
    ...
    override func viewDidLoad()
    {
        ...
        // load the banner
        engageAd.load(zoneId: "splash_spin_lite", adLoadCallback: self, adEventCallback: self, viewController: self)
...
extension SplashSpinLiteViewController: AdLoadCallback
{
...
extension SplashSpinLiteViewController: AdEventCallback
{
