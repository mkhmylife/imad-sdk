...
import IMAd
class SplashCardViewController: UIViewController
{
    ...
    override func viewDidLoad()
    {
        ...
        // load the banner
        engageAd.load(zoneId: "splash_cards", adLoadCallback: self, adEventCallback: self, viewController: self)
...
extension SplashCardViewController: AdLoadCallback
{
...
extension SplashCardViewController: AdEventCallback
{
