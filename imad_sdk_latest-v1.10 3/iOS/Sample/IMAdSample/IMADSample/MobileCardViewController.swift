...
import IMAd
class MobileCardViewController: UIViewController
{
    ...
    override func viewDidLoad()
    {
        ...
        // load the banner
        engageAd.load(zoneId: "mobile_cards", adLoadCallback: self, adEventCallback: self, viewController: self)
...
extension MobileCardViewController: AdLoadCallback
{
...
extension MobileCardViewController: AdEventCallback
{
