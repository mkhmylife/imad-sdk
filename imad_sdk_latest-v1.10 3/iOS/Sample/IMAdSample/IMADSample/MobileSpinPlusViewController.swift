...
import IMAd
class MobileSpinPlusViewController: UIViewController
{
    ...
    override func viewDidLoad()
    {
        ...
        engageAd.load(zoneId: "spin_plus", adLoadCallback: self, adEventCallback: self, viewController: self)
    }
...
extension MobileSpinPlusViewController: AdLoadCallback
{
...
extension MobileSpinPlusViewController: AdEventCallback
{
